...
#Educational Attainment:Relationship Between Education Level and Attainment Shares
```{r}
...
# Analysis 3 
#Fields of Study:Relationship Between Field of Study and Graduate Shares
```{r}
...
# Analysis 4
#PPP-Adjusted Annual Wages:Relationship Between Country and PPP-Adjusted Wages
```{r}
wages_reg <- wages %>%
  mutate(
...
# Analysis 5
#Relative Earnings by Education Level and Age Group
```{r}
reg_data <- data_long4 %>%
